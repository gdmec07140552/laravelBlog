<div class="layui-side layui-bg-black x-side">
    <div class="layui-side-scroll">
        <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
            <li class="layui-nav-item" style="{:getNav(['Banner'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe634;</i><cite>轮播管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Banner', 'list'], 1)}">
                        <dd class="">
                            <a href="javascript:;" _href="{{url('admin/banner/index')}}">
                                <cite>轮播图列表</cite>
                            </a>
                        </dd>
                    </dd>
            ...
            <li class="layui-nav-item" style="{:getNav(['Category', 'Article'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe630;</i><cite>文章管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Category', 'list'], 1)}">
                        <dd class="">
                            <a href="javascript:;" _href="{{url('Category/list')}}">
                                <cite>分类列表</cite>
                            </a>
                        </dd>
                    </dd>
                    <dd class="" style="{:getNav(['Article', 'list'], 1)}">
                        <dd class="">
                            <a href="javascript:;" _href="{:url('Article/list')}">
                                <cite>文章列表</cite>
                            </a>
                        </dd>
                    </dd>
            ...
            <li class="layui-nav-item" style="{:getNav(['Author'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe630;</i><cite>作者管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Author', 'list'], 1)}">
                        <dd class="">
                            <a href="javascript:;" _href="{:url('Author/list')}">
                                <cite>作者列表</cite>
                            </a>
                        </dd>
                    </dd>
            ...
            <li class="layui-nav-item" style="{:getNav(['Tag'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe630;</i><cite>标签管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Tag', 'list'], 1)}">
                        <dd class="">
                            <a href="javascript:;" _href="{:url('Tag/list')}">
                                <cite>标签列表</cite>
                            </a>
                        </dd>
                    </dd>
            ...
            <li class="layui-nav-item" style="{:getNav(['Question'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe607;</i><cite>问题管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Question', 'list'], 1)}">
                        <dd class="">
            ...
            <li class="layui-nav-item" style="{:getNav(['Product'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe62d;</i><cite>产品管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Product', 'list'], 1)}">
                        <dd class="">
            ...
            <li class="layui-nav-item" style="{:getNav(['Order'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe642;</i><cite>订单管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Order', 'list'], 1)}">
                        <dd class="">
                            <a href="javascript:;" _href="./welcome.html">
                                <cite>订单列表（待开发）</cite>
                            </a>
            ...
            <li class="layui-nav-item"  style="{:getNav(['Comment'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe606;</i><cite>评论管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Comment', 'list'], 1)}">
            ...
            <li class="layui-nav-item" style="{:getNav(['Member'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe612;</i><cite>会员管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Member', 'list'], 1)}">
            ...
            <li class="layui-nav-item" style="{:getNav(['Admin', 'Role', 'Auth', 'AdminLog'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe613;</i><cite>管理员管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Admin', 'list'], 1)}">
                        <a href="javascript:;" _href="{:url('Admin/list')}">
                            <cite>管理员列表</cite>
                        </a>
                    </dd>
                    <dd class="" style="{:getNav(['Role', 'list'], 1)}">
                        <a href="javascript:;" _href="{:url('Role/list')}">
                            <cite>角色管理</cite>
                        </a>
                    </dd>
                    <dd class="" style="{:getNav(['AdminCate', 'list'], 1)}">
                        <a href="javascript:;" _href="./admin-cate.html">
                            <cite>权限分类</cite>
                        </a>
                    </dd>
                    <dd class="" style="{:getNav(['Auth', 'list'], 1)}">
                        <a href="javascript:;" _href="{:url('Auth/list')}">
                            <cite>权限管理</cite>
                        </a>
                    </dd>
                    <dd class="" style="{:getNav(['AdminLog', 'list'], 1)}">
                        <a href="javascript:;" _href="{:url('AdminLog/list')}">
                            <cite>管理员日志</cite>
                        </a>
                    </dd>
                </dl>
            </li>
            <li class="layui-nav-item" style="{:getNav(['Echart'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe629;</i><cite>系统统计</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Echart', 'list'], 1)}">
            ...
            <li class="layui-nav-item" style="{:getNav(['System','Conf'], 0)}">
                <a class="javascript:;" href="javascript:;">
                    <i class="layui-icon" style="top: 3px;">&#xe614;</i><cite>系统设置</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd class="" style="{:getNav(['Conf', 'list'], 1)}">
                        <a href="javascript:;" _href="{:url('Conf/list')}">
                            <cite>网站配置</cite>
                        </a>
                    </dd>
                    <dd class="" style="{:getNav(['System', 'list'], 1)}">
